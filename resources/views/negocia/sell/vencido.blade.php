...
<body class="body-sell">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card-sell shadown-sell card-body-fail-sell">
                    <div  width="600px" height="50px" align="center">
                        <div align="center">
                            <h3 style="margin-bottom: 0px;">O seu boleto excedeu o prazo máximo para pagamento</h3>
                            <h5 style="margin-bottom: 0px;">Entre em contato pelo email email@email.com</h5>
                        </div>
                    </div>
                </div>
            </div>
